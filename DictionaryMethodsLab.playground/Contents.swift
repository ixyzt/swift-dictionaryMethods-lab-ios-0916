 ...
 */
var starWarsVillains = ["Darth Vader", "Emporor Palpatine"]
 ...
 */
var starWarsDroids = ["R2-D2", "C-3P0", "BB-88", "IG-88"]
...
if starWarsCharacters.isEmpty {
    print("The dictionar is empty!")
} else {
    print("There are \(starWarsCharacters.keys.count) items in the dictionary")
}
 ...
 */
starWarsCharacters.removeValue(forKey: "Bounty Hunters")
